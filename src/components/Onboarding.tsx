...
/** First-run taste quiz. Shown once until the user finishes or skips it. */
      ...
      {!onboarded && (
        ...
        >
          <motion.div
            ...
            className="max-h-[92svh] w-full max-w-[460px] overflow-y-auto rounded-t-3xl border border-line bg-panel p-6 pb-8 sm:rounded-3xl"
          >
            ...
            <p className="mb-5 text-sm text-muted-foreground">
              ...
              made for you. Change it anytime from settings.
            </p>
